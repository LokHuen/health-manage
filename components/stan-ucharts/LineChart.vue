<template>
	<view class="line_chart">
		<canvas :canvasId="canvasId" id="canvasId" disable-scroll="true" :style="{ width: cWidth + 'px', height: cHeight + 'px' }"
	...
	export default {
		...
		methods: {
			showCharts() {
					...
					yAxis: {
						...
						format: val => {
							...
							let {
								...
								fixed,
								name
							} = this.yAxisAs && this.yAxisAs.formatter ? Object.assign(defaultSetting, this.yAxisAs.formatter) :
								defaultSetting;
							if (type == 'number') {
				...
				optionAs[this.canvasId] = Object.assign(defaultOption, this.basicAs, this.xAxisAs, this.yAxisAs, this.legendAs,
					this.extraAs);
				...
				lineCharts[this.canvasId].showToolTip(e, {
					...
					format: function(item, category) {
						...
						let {
							...
							fixed,
							name
						} = that.yAxisAs && that.yAxisAs.formatter ? Object.assign(defaultSetting, that.yAxisAs.formatter) :
							defaultSetting;
