<template>
	<view class="container">
		...
		<view v-if="preimg" style="position: fixed;left:0;right:0;top:0;bottom:0;">
			<avatar selWidth="280px" :selHeight="(imgindex==1?280:360)+'px'" ref='avatar' @upload="myUpload" :avatarSrc="preimg" :avatarStyle="'width: 280px; height: '+(imgindex==1?280:360)+'px; margin: 40px;'"></avatar>
		</view>
