		...
		methods: {
			toPatientList(index,secondIndex){
			  ...
			  if(index==0){
				...
				uni.navigateTo({
					url:'patient-list?isDepartmentIcu='+isDepartmentIcu+'&month='+month+'&surveyResultText='+surveyResultText+
					'&surveyResult='+surveyResult+'&isBuyText='+isBuyText+'&isBuy='+isBuy+'&queryType='+queryType+'&doctorName='+this.doctorInfo.doctorName
				})
			},
			select(index){
		...
		.detail-box{
			...
			.detali-list-box{
				...
				.detali-list-item{
					...
					.detail1{
						font-size: 46rpx;font-family: PingFang SC;font-weight: 500;
					}
					.detail2{
						font-size: 26rpx;font-family: PingFang SC;font-weight: 400; color: #666666;
					}
					.detali-name{
						font-size: 24rpx;
						font-family: PingFang SC;
