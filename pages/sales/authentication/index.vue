	...
	<view>
		<view class="contentbox">
			...
			<view class="uploadbox flex" @click="sendpicture(1)">
				<image :src="form.idCardFront?(baseUrl+form.idCardFront):'../../../static/sales/auth/1.png'" mode="widthFix"></image>
			</view>
			<view class="uploadbox flex" @click="sendpicture(2)">
				<image :src="form.idCardBack?(baseUrl+form.idCardBack):'../../../static/sales/auth/2.png'" mode="widthFix"></image>
			</view>
			<view class="uploadbox flex" @click="sendpicture(3)">
				<image :src="form.handIdCard?(baseUrl+form.handIdCard):'../../../static/sales/auth/3.png'" mode="widthFix"></image>
				<view class="textbox">
					<view>照片必须清晰可见上半身及身份证人像面信息</view>
				</view>
			</view>
			<view class="uploadbox flex" @click="sendpicture(4)">
				<image :src="form.bankCardFront?(baseUrl+form.bankCardFront):'../../../static/sales/auth/4.png'" mode="widthFix"></image>
			</view>
			<!-- <view class="uploadbox flex" @click="sendpicture(5)">
				<image :src="form.bankCardBack?(baseUrl+form.bankCardBack):'../../../static/sales/auth/5.png'" mode="widthFix"></image>
				
			</view> -->
			<!-- <view class="uploadbox flex" @click="sendpicture(6)">
				<image :src="form.handBankCard?(baseUrl+form.handBankCard):'../../../static/sales/auth/6.png'" mode="widthFix"></image>
				<view class="textbox">
