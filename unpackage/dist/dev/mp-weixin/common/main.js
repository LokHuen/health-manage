...
/* 0 */
/*!*****************************************************!*\
  !*** /Users/weinijun/Desktop/tjbgjd_applet/main.js ***!
  \*****************************************************/
...
_vue.default.prototype.$imageUrl = "https://bgjdapi-test.ttxyw.cn/upload/mini";
...
/* 5 */
/*!*****************************************************!*\
  !*** /Users/weinijun/Desktop/tjbgjd_applet/App.vue ***!
  \*****************************************************/
/*! no static exports found */
...
/* 6 */
/*!******************************************************************************!*\
  !*** /Users/weinijun/Desktop/tjbgjd_applet/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 7 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/weinijun/Desktop/tjbgjd_applet/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _api = __webpack_require__(/*! common/api */ 8);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =
...

{
  ...
  _api.api), {}, {
    ...
    setCacheAsync: function setCacheAsync(key, data) {
      //异步保存数据
      uni.setStorage({
        key: key,
        data: data,
    ...
    getCache: function getCache(key) {//获取缓存
      return uni.getStorageSync(key);
    },
    setCache: function setCache(key, data) {//保存缓存
      uni.setStorageSync(key, data);
    },
    tip: function tip(text, time) {//消息提示
      uni.showToast({
        title: text || "",
        duration: time || 1500,
        icon: "none" });
    ...
    loading: function loading(content, mask) {//加载中
      content = content || "";
      uni.showLoading({
        title: content,
        mask: mask || false });
    ...
    loaded: function loaded() {//取消加载提示
      uni.hideLoading();
    },
    saveinfo: function saveinfo(info) {var _this = this;
      if (info) {
        this.saveuserinfo({
          mobile: info.phone || "",
        ...
        uni.getUserInfo({
          ...
          success: function success(res) {
            _this.saveinfo(res.userInfo);
          } });

      }
    },
    replymessage: function replymessage() {//调起订阅消息
    ...
    uploadImage: function uploadImage(url, _success, data) {var _this2 = this;
      var formData = _objectSpread({ 'tkbgjd-token': uni.getStorageSync("token") }, data);
      uni.chooseImage({
        success: function success(res) {
          var paths = res.tempFilePaths;
          for (var i = 0; i < paths.length; i++) {
            uni.uploadFile({
              url: _this2.globalData.baseUrl + url,
              filePath: paths[i],
              name: 'file',
              formData: formData,
              success: function success(res) {
                _success(JSON.parse(res.data));
              } });
    ...
    uploadImage2: function uploadImage2(url, _success2, data, maxSize) {var _this3 = this;
      var formData = _objectSpread({ 'tkbgjd-token': uni.getStorageSync("token") }, data);
      uni.chooseImage({
        success: function success(res) {
          var paths = res.tempFilePaths;
          for (var i = 0; i < paths.length; i++) {
            uni.uploadFile({
              url: _this3.globalData.baseUrl + url,
              filePath: paths[i],
              name: 'file',
              formData: formData,
              success: function success(res) {
                _success2(JSON.parse(res.data));
              } });
...
/* 10 */
/*!**************************************************************************************!*\
  !*** /Users/weinijun/Desktop/tjbgjd_applet/App.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 11 */
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/weinijun/Desktop/tjbgjd_applet/App.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
